function VBObox0() {
    ...
    this.vboContents = new Float32Array([ 
        ...
        1.0,
        0.0,
        0.0, //1 vertex:pos x,y,z,w; color: r,g,b
        -0.5,
        -0.5,
        0.0,
        1.0,
...
VBObox0.prototype.draw = function () {
    ...
    gl.drawArrays(
        gl.TRIANGLES, // select the drawing primitive to draw,
...
function VBObox1() {
    ...
    */
    ...
    this.vboContents = new Float32Array([ //---------------------------------------------------------
        // Array of vertex attribute values we will
    ...
    console.assert(
        (this.vboFcount_a_Pos1 + // check the size of each and
...
VBObox1.prototype.draw = function () {
    ...
    // ----------------------------Draw the contents of the currently-bound VBO:
    gl.drawArrays(
        gl.POINTS, // select the drawing primitive to draw:
        // choices: gl.POINTS, gl.LINES, gl.LINE_STRIP, gl.LINE_LOOP,
        //          gl.TRIANGLES, gl.TRIANGLE_STRIP,
        0, // location of 1st vertex to draw;
        this.vboVerts
...
function VBObox2() {
    ...
    this.vboOffset_a_PtSize =
        (this.vboFcount_a_Position + this.vboFcount_a_Color) * this.FSIZE;
    // == 7 floats * bytes/float
    // # of bytes from START of vbo to the START
    // of 1st a_PtSize attrib value in vboContents[]
...
VBObox2.prototype.adjust = function () {
    ...
    this.vboContents[15] =
        15.0 * (1.0 + Math.cos((Math.PI * 3.0 * g_angleNow1) / 180.0)); // radians
...
VBObox2.prototype.draw = function () {
    ...
    gl.drawArrays(
        gl.LINE_LOOP, // draw lines between verts too!
        0,
        this.vboVerts
    );
};
